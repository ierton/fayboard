...
var Types$Foo = function(slot1){
  return function(slot2){
    return new Fay$$$(function(){
      return new $_Types$Foo(slot1,slot2);
    });
  };
};
var Types$Bar = function(slot1){
  return new Fay$$$(function(){
    return new $_Types$Bar(slot1);
  });
};
var Types$Package = function(foo){
  return function(bar){
    return new Fay$$$(function(){
      return new $_Types$Package(foo,bar);
    });
  };
};
var Types$foo = function(x){
  return new Fay$$$(function(){
    return Fay$$_(x).foo;
  });
};
var Types$bar = function(x){
  return new Fay$$$(function(){
    return Fay$$_(x).bar;
  });
};
...
var Alert$main = new Fay$$$(function(){
  return Fay$$_(Alert$alert)(Fay$$list("Hello, World!"));
});
var Alert$alert = function($p1){
  return new Fay$$$(function(){
    return new Fay$$Monad(Fay$$jsToFay(["unknown"],window.alert(Fay$$fayToJs_string($p1))));
  });
};
var Alert$ajaxJson = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
var $_Types$Foo = function(slot1,slot2){
  this.slot1 = slot1;
  this.slot2 = slot2;
};
var $_Types$Bar = function(slot1){
  this.slot1 = slot1;
};
var $_Types$Package = function(foo,bar){
  this.foo = foo;
  this.bar = bar;
};
...
var Fay$$fayToJsUserDefined = function(type,obj){
  ...
  if (_obj instanceof $_Types$Foo) {
    var obj_ = {"instance": "Foo"};
    var obj_slot1 = Fay$$fayToJs_int(_obj.slot1);
    if (undefined !== obj_slot1) {
      obj_['slot1'] = obj_slot1;
    }
    var obj_slot2 = Fay$$fayToJs_string(_obj.slot2);
    if (undefined !== obj_slot2) {
      obj_['slot2'] = obj_slot2;
    }
    return obj_;
  }
  if (_obj instanceof $_Types$Bar) {
    var obj_ = {"instance": "Bar"};
    var obj_slot1 = Fay$$fayToJs(["list",[["user","Foo",[]]]],_obj.slot1);
    if (undefined !== obj_slot1) {
      obj_['slot1'] = obj_slot1;
    }
    return obj_;
  }
  if (_obj instanceof $_Types$Package) {
    var obj_ = {"instance": "Package"};
    var obj_foo = Fay$$fayToJs(["user","Foo",[]],_obj.foo);
    if (undefined !== obj_foo) {
      obj_['foo'] = obj_foo;
    }
    var obj_bar = Fay$$fayToJs(["user","Bar",[]],_obj.bar);
    if (undefined !== obj_bar) {
      obj_['bar'] = obj_bar;
    }
    return obj_;
  }
...
var Fay$$jsToFayUserDefined = function(type,obj){
  ...
  if (obj["instance"] === "Foo") {
    return new $_Types$Foo(Fay$$jsToFay_int(obj["slot1"]),Fay$$jsToFay_string(obj["slot2"]));
  }
  if (obj["instance"] === "Bar") {
    return new $_Types$Bar(Fay$$jsToFay(["list",[["user","Foo",[]]]],obj["slot1"]));
  }
  if (obj["instance"] === "Package") {
    return new $_Types$Package(Fay$$jsToFay(["user","Foo",[]],obj["foo"]),Fay$$jsToFay(["user","Bar",[]],obj["bar"]));
  }
...
// Exports
this.Alert$ajaxJson = Alert$ajaxJson;
this.Alert$alert = Alert$alert;
this.Alert$main = Alert$main;
