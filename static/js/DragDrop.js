...
function OnMouseDown(e) { // IE is retarded and doesn't pass the event object
  ...
  _debug.innerHTML = target.className == 'drag' ? 
      ...
      'NON-draggable element clicked'; // for IE, left click == 1 // for Firefox, left click == 0 
  
  if ((e.button == 1 && window.event != null ||
       e.button == 0) && target.className == 'drag') { // grab the mouse position 
    ...
    target.style.zIndex = 10000; // we need to access the element in OnMouseMove 
